...
*/
stylo.model.DocTypeController = class DocTypeController extends stylo.ui.form.Controller {
	setup() {
		// setup formatters for fieldtype
		stylo.meta.docfield_map[
	...
	show_db_utilization() {
		...
		stylo
			.xcall("stylo.core.doctype.doctype.doctype.get_row_size_utilization", {
				doctype,
			})
			.then((r) => {
				if (r < 50.0) return;
