...
stylo.ui.Scanner = class Scanner {
	constructor(options) {
		this.dialog = null;
		this.handler = null;
		...
		if (options.container) {
			...
			this.scan_area_id = stylo.dom.set_unique_id(this.$scan_area);
		}
		if (options.dialog) {
	...
	load_lib() {
		return stylo.require("/assets/stylo/node_modules/html5-qrcode/dist/html5-qrcode.min.js");
	}
};
