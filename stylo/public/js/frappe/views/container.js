...
stylo.views.Container = class Container {
	...
	change_to(label) {
		...
		this.page._route = stylo.router.get_sub_path();
		$(this.page).trigger("show");
		!this.page.disable_scroll_to_top && stylo.utils.scroll_to(0);
	...
	has_sidebar() {
		var flag = 0;
		var route_str = stylo.get_route_str();
		// check in stylo.ui.pages
		flag = stylo.ui.pages[route_str] && !stylo.ui.pages[route_str].single_column;

		// sometimes stylo.ui.pages is updated later,
