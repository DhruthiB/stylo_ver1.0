...
stylo.provide("stylo.widget");

stylo.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
stylo.widget.make_widget = (opts) => {
	const widget_class = stylo.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = stylo.widget.make_widget({
			...widget,
...
stylo.widget.WidgetGroup = WidgetGroup;
stylo.widget.SingleWidgetGroup = SingleWidgetGroup;
