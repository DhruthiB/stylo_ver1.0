stylo.ui.form.ControlSignature = class ControlSignature extends stylo.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		stylo.require("/assets/stylo/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${stylo.utils.icon("restriction", "md")}</i>
