...
stylo.ui.form.ControlComment = class ControlComment extends stylo.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				${stylo.avatar(stylo.session.user, "avatar-medium")}
					<div class="stylo-control col"></div>
				</div>
		...
		`)
			: $('<div class="stylo-control"></div>');

		this.comment_wrapper.appendTo(this.parent);

		// wrapper should point to stylo-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".stylo-control")
