...
stylo.ui.form.QuickEntryForm = class QuickEntryForm {
	...
	render_dialog() {
		...
		this.dialog.onhide = () => (stylo.quick_entry = null);
		this.dialog.show();
			...
			stylo.call({
				...
				callback: function (r) {
					if (
						...
						me.dialog.hide();
						// delete the old doc
						stylo.model.clear_doc(me.dialog.doc.doctype, me.dialog.doc.name);
						me.dialog.doc = r.message;
						if (stylo._from_link) {
							stylo.ui.form.update_calling_link(me.dialog.doc);
						} else {
							if (me.after_insert) {
