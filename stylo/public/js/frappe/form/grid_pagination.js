export default class GridPagination {
	...
	get_pagination_html() {
		...
		return $(`<button class="btn btn-secondary btn-xs first-page"">
			...
			<button class="btn btn-secondary btn-xs prev-page">${stylo.utils.icon("left", "xs")}</button>
			${page_text_html}
			<button class="btn btn-secondary btn-xs next-page">${stylo.utils.icon("right", "xs")}</button>
