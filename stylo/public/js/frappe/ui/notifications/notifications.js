...
class NotificationsView extends BaseNotificationsView {
	...
	get_dropdown_item_html(field) {
		...
		let timestamp = stylo.datetime.comment_when(field.creation);
	...
	get_notifications_list(limit) {
		return stylo.call(
			"stylo.desk.doctype.notification_log.notification_log.get_notification_logs",
			{ limit: limit }
		);
	}
...
class EventsView extends BaseNotificationsView {
	make() {
		...
		stylo
			.xcall("stylo.desk.doctype.event.event.get_events", {
				start: today,
				end: today,
			})
			.then((event_list) => {
