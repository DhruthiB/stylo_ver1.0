		...
		<div class="row form-section visible-section">
			...
			<div class="section-body">
				<div class="form-column col-sm-12">
					<form>
						<div
							class="form-group stylo-control input-max-width"
						...
						<div class="stylo-control" data-fieldtype="Table">
							<div>
								<div class="form-grid">
																		...
																		<div class="section-body">
																			...
																			>
																				<form>
																					...
																					<div
																						class="stylo-control input-max-width"
																					>
																						<div
																							class="form-group"
																						>
