...
stylo.views.BaseList = class BaseList {
	...
	setup_page() {
		...
		!this.hide_card_layout && this.page.main.addClass("stylo-card");
	...
	setup_side_bar() {
		if (this.hide_sidebar || !stylo.boot.desk_settings.list_sidebar) return;
	...
	setup_result_area() {
		...
		this.$stylo_list.append(this.$result);
	}
