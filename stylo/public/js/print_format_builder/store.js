...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			stylo.model.clear_doc("Print Format", print_format_name);
			stylo.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = stylo.get_doc("Print Format", print_format_name);
				stylo.model.with_doctype(_print_format.doc_type, () => {
					meta.value = stylo.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return stylo.db.get_doc("Letter Head", _letterhead).then((doc) => {
