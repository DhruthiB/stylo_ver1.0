		...
		methods: {
			fetch() {
				return new Promise((resolve) => {
					stylo.model.clear_doc("Print Format", this.print_format_name);
					stylo.model.with_doc("Print Format", this.print_format_name, () => {
						let print_format = stylo.get_doc("Print Format", this.print_format_name);
						stylo.model.with_doctype(print_format.doc_type, () => {
							this.meta = stylo.get_meta(print_format.doc_type);
			...
			change_letterhead(letterhead) {
				return stylo.db.get_doc("Letter Head", letterhead).then((doc) => {
					this.letterhead = doc;
				});
			},
		},
