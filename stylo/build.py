...
def fetch_assets(url, frappe_head):
	...
	click.echo(click.style("✔", fg="green") + f" Downloaded Stylo assets from {url}")
...
def download_frappe_assets(verbose=True) -> bool:
	"""Download and set up Stylo assets if they exist based on the current commit HEAD.
	...
	try:
		...
		# TODO: log traceback in forge.log
