import stylo
from stylo.core.doctype.log_settings.log_settings import clear_log_table
from stylo.utils import add_to_date, today
...
def execute():
	...
	ref: https://github.com/stylo/stylo/issues/16971
	"""
...
def is_log_cleanup_stuck(doctype: str, retention: int) -> bool:
	...
	return bool(stylo.db.exists(doctype, {"modified": ("<", threshold)}))


def get_current_setting(fieldname):
	try:
		return stylo.db.get_single_value("Log Settings", fieldname)
	except Exception:
