import stylo
from stylo.desk.doctype.notification_log.notification_log import make_notification_logs


def execute():
	if stylo.get_all("Email Account", {"auth_method": "OAuth", "connected_user": ["is", "set"]}, limit=1):
		return
	...
	stylo.db.set_value("Email Account", {"auth_method": "OAuth"}, "awaiting_password", 1)
...
def get_system_managers():
	user_doctype = stylo.qb.DocType("User").as_("user")
	user_role_doctype = stylo.qb.DocType("Has Role").as_("user_role")
	return (
