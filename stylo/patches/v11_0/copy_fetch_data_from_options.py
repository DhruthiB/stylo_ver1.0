...
def execute():
	stylo.reload_doc("core", "doctype", "docfield", force=True)
	stylo.reload_doc("custom", "doctype", "custom_field", force=True)
	stylo.reload_doc("custom", "doctype", "customize_form_field", force=True)
	stylo.reload_doc("custom", "doctype", "property_setter", force=True)
