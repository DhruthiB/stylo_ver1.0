...
class MyAppSearch(SQLiteSearch):
    ...
    def get_search_filters(self):
        ...
        accessible_projects = stylo.get_all(
            "Project",
...
1. **Post-Migration Index Building**: Builds the search index automatically after running `forge migrate`
...
def build_index_in_background():
    ...
    if search.is_search_enabled() and not search.index_exists():
        stylo.enqueue("my_app.search.build_index", queue="long")
