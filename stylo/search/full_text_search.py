...
class FullTextSearch:
	...
	def create_index(self):
		stylo.create_folder(self.index_path)
	...
	def search(self, text: str, scope: str | None = None, limit: int = 20) -> list[stylo._dict]:
...
def get_index_path(index_name):
	return stylo.get_site_path("indexes", index_name)
