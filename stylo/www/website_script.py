...
def get_context(context):
	context.javascript = stylo.db.get_single_value("Website Script", "javascript") or ""
...
def get_setting(field_name):
	...
	website_settings = stylo.db.get_single_value("Website Settings", field_name)
	conf = stylo.conf.get(field_name)
