...
from stylo.utils import validate_url

# test_records = stylo.get_test_records('Email Group')


class TestEmailGroup(StyloTestCase):
	def test_welcome_url(self):
		email_group = stylo.new_doc("Email Group")
