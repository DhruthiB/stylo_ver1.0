...
test_records = stylo.get_test_records("Email Domain")


class TestDomain(StyloTestCase):
	def setUp(self):
		make_test_objects("Email Domain", reset=True)

	def tearDown(self):
		stylo.delete_doc("Email Account", "Test")
		stylo.delete_doc("Email Domain", "test.com")

	def test_on_update(self):
		mail_domain = stylo.get_doc("Email Domain", "test.com")
		mail_account = stylo.get_doc("Email Account", "Test")
