...
import stylo
import stylo.desk.form.document_follow as document_follow
from stylo.desk.form.assign_to import add
from stylo.desk.form.document_follow import get_document_followed_by_user
from stylo.desk.form.utils import add_comment
from stylo.desk.like import toggle_like
from stylo.query_builder import DocType
from stylo.query_builder.functions import Cast_
from stylo.share import add as share
from stylo.tests.utils import StyloTestCase


class TestDocumentFollow(StyloTestCase):
	...
	def tearDown(self):
		...
		stylo.db.delete("Document Follow")
	...
	doc = stylo.get_doc(
		{
			...
			"doc.starts_on": stylo.utils.now(),
			"doc.ends_on": stylo.utils.add_days(stylo.utils.now(), 5),
...
def get_user(document_follow=None):
	...
	if stylo.db.exists("User", "test@docsub.com"):
		doc = stylo.delete_doc("User", "test@docsub.com")
	doc = stylo.new_doc("User")
