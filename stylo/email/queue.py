...
def get_unsubcribed_url(reference_doctype, reference_name, email, unsubscribe_method, unsubscribe_params):
	...
	# for test
	stylo.local.flags.signed_query_string = query_string
...
def unsubscribe(doctype, name, email):
	...
	if not stylo.flags.in_test and not verify_request():
		return
...
def flush():
	...
	from stylo.email.doctype.email_queue.email_queue import send_mail
