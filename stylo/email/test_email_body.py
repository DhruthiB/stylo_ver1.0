...
import stylo
from stylo import safe_decode
from stylo.core.doctype.communication.communication import Communication
from stylo.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from stylo.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from stylo.email.receive import Email, InboundMail
...
<div>
	...
	<img embed="assets/stylo/images/stylo-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/stylo/images/stylo-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = stylo.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="stylo-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/stylo/images/stylo-favicon.svg" alt="test" />
...
"""
		...
		# https://github.com/stylo/stylo/pull/3371
		# self.assertEqual(mail.from_real_name, '"fail@example.com" via DEF')

		email_account = stylo._dict({"email_id": "receive@example.com"})
