...
def pass_context(f):
	...
	def _func(ctx, *args, **kwargs):
		...
		try:
			...
			stylo.exceptions.SiteNotSpecifiedError,
			stylo.exceptions.IncorrectSitePath,
			stylo.exceptions.CommandFailedError,
		) as e:
...
def get_commands():
	...
	clickable_link = "https://styloframework.com/docs"
	all_commands = (
		scheduler_commands
		+ site_commands
		+ testing_commands
