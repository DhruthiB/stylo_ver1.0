...
def pass_context(f):
	...
	def _func(ctx, *args, **kwargs):
		...
		try:
			ret = f(stylo._dict(ctx.obj), *args, **kwargs)
		except stylo.exceptions.SiteNotSpecifiedError as e:
			click.secho(str(e), fg="yellow")
			sys.exit(1)
		except stylo.exceptions.IncorrectSitePath:
...
def get_site(context, raise_err=True):
	try:
		...
		if raise_err:
			raise stylo.SiteNotSpecifiedError
		return None
...
def get_commands():
	...
	clickable_link = "\x1b]8;;https://styloframework.com/docs\astyloframework.com\x1b]8;;\a"
