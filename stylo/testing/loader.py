...
import stylo
from stylo.modules.utils import get_module_name
from stylo.testing.config import TestParameters


class StyloTestLoader(unittest.TestLoader):
	...
	def discover_tests(self, params: TestParameters) -> unittest.TestSuite:
		...
		if self.params.tests:
			...
			files = self.get_files(stylo.get_installed_apps())
			...
			module = stylo.get_cached_value("DocType", self.params.doctype, "module")
			app = stylo.get_cached_value("Module Def", module, "app_name")
