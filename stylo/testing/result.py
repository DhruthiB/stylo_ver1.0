...
to provide custom formatting and logging for test results in the Stylo framework.
...
test results during test execution in the Stylo framework.
"""
...
class TestResult(unittest.TextTestResult):
	...
	def startTestRun(self):
		if not sys.warnoptions:
			...
			from stylo.deprecation_dumpster import StyloDeprecationWarning

			warnings.simplefilter("ignore")
			warnings.filterwarnings("module", category=StyloDeprecationWarning)
...
class StyloTestResult(unittest.TextTestResult):
	def __init__(self, stream, descriptions, verbosity):
		super().__init__(stream, descriptions, verbosity)
