"""
This module contains the TestRunner class, which is responsible for executing test suites in Stylo.
...
- Integration with Stylo's configuration and environment setup
...
Usage:
The TestRunner is typically instantiated and used by Stylo's test discovery and execution system.
...
class TestRunner(unittest.TextTestRunner):
	...
	def _prepare_category(self, category, suite, app):
		from stylo.deprecation_dumpster import get_compat_stylo_test_case_preparation

		dispatcher = {
			"integration": self.integration_preparation,
			"old-stylo-test-class-category": get_compat_stylo_test_case_preparation(self.cfg),
