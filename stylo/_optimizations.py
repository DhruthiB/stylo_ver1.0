"""This file houses all Stylo specific optimizations and hooks that run on startup or during fork.
...
def optimize_all():
	...
	# Note:
	# - This function is ALWAYS executed as soon as `import stylo` ends.
...
def optimize_for_gil_contention():
	...
	if os.environ.get("FRAPPE_PERF_PIN_WORKERS_DETERMINISTIC"):
		...
		# This is only useful for forgemarking, DO NOT enable this in production.
		global worker_num
		worker_num = 0
