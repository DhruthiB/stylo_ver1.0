...
def make_mapped_doc(method, source_name, selected_children=None, args=None):
	...
	if method not in stylo.whitelisted:
...
def get_mapped_doc(
	...
	# main
	if not target_doc:
		target_doc = stylo.new_doc(table_maps[from_doctype]["doctype"])
...
def map_child_doc(source_d, target_parent, table_map, source_parent=None):
	...
	target_d = stylo.new_doc(target_child_doctype, target_parent, target_parentfield)
