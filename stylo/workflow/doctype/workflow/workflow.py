...
from stylo.model.workflow import DEFAULT_WORKFLOW_TASKS
...
class Workflow(Document):
	...
	if TYPE_CHECKING:
		...
		from stylo.workflow.doctype.workflow_document_state.workflow_document_state import (
			WorkflowDocumentState,
		)
		from stylo.workflow.doctype.workflow_transition.workflow_transition import WorkflowTransition
...
def get_workflow_methods():
	return [i["name"] for i in stylo.get_hooks("workflow_methods")] + DEFAULT_WORKFLOW_TASKS
