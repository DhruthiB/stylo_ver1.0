...
class ImportMapper:
	...
	def __call__(self, *args: Any, **kwds: Any) -> Callable:
		db = db_type_is(stylo.conf.db_type)
...
def execute_query(query, *args, **kwargs):
	...
	result = stylo.local.db.sql(query, params, *args, **kwargs)  # nosemgrep
...
def prepare_query(query):
	...
	if stylo.local.flags.get("in_safe_exec", False):
		from stylo.utils.safe_exec import SERVER_SCRIPT_FILE_PREFIX, check_safe_sql_query
