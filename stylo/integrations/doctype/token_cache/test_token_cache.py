...
class TestTokenCache(StyloTestCase):
	def setUp(self):
		self.token_cache = stylo.get_last_doc("Token Cache")
		self.token_cache.update({"connected_app": stylo.get_last_doc("Connected App").name})
