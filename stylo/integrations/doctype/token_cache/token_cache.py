...
from stylo.utils import cint, cstr, get_datetime, get_system_timezone
...
class TokenCache(Document):
	...
	def get_auth_header(self):
		...
		raise stylo.exceptions.DoesNotExistError
	...
	def update_data(self, data):
		...
		if token_type not in ["bearer", "mac"]:
			stylo.throw(_("Received an invalid token type."))
		# 'Bearer' or 'MAC'
