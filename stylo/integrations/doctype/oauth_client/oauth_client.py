...
from stylo.permissions import SYSTEM_USER_ROLE
...
class OAuthClient(Document):
	...
	if TYPE_CHECKING:
		from stylo.integrations.doctype.oauth_client_role.oauth_client_role import OAuthClientRole
	...
	def client_id_issued_at(self) -> int:
		...
		try:
			...
			return int(stylo.utils.now_datetime().timestamp())
