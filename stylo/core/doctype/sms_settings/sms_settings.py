...
class SMSSettings(Document):
	...
	if TYPE_CHECKING:
		from stylo.core.doctype.sms_parameter.sms_parameter import SMSParameter
...
def send_sms(receiver_list, msg, sender_name="", success_msg=True):
	send_sms_hook_methods = stylo.get_hooks("send_sms")
	if send_sms_hook_methods:
		return stylo.get_attr(send_sms_hook_methods[-1])(receiver_list, msg, sender_name, success_msg)
