...
class Communication(Document, CommunicationEmailMixin):
	...
	if TYPE_CHECKING:
		from stylo.core.doctype.communication_link.communication_link import CommunicationLink
...
def parse_email(email_strings):
	...
	for email_string in email_strings:
		...
		for email in email_string.split(","):
			...
			doctype = stylo.unscrub(unquote_plus(document_parts[0]))
