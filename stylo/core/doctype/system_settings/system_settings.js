stylo.ui.form.on("System Settings", {
	...
	after_save: function (frm) {
		...
		const attr_tuples = [
			[frm.doc.language, stylo.boot.sysdefaults.language, stylo.boot.user.language],
			[frm.doc.rounding_method, stylo.boot.sysdefaults.rounding_method], // no user override.
		];
