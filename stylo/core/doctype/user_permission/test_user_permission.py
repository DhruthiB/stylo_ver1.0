...
from stylo.permissions import has_user_permission
from stylo.tests.utils import StyloTestCase
from stylo.website.doctype.blog_post.test_blog_post import make_test_blog


class TestUserPermission(StyloTestCase):
	def setUp(self):
		test_users = (
	...
	def test_default_user_permission_corectness(self):
		...
		stylo.delete_doc("Blog Post", test_blog.name)
	...
	def test_default_user_permission(self):
		...
		for category in ["general", "public"]:
			if not stylo.db.exists("Blog Category", category):
				stylo.get_doc({"doctype": "Blog Category", "title": category}).insert()
	...
	def test_user_perm_for_nested_doctype(self):
		...
		stylo.cache().delete_value("user_permissions")
