	...
	refresh: function (frm) {
		if (frm.doc.file_url) {
			frm.add_custom_button(__("View File"), () => {
				if (!stylo.utils.is_url(frm.doc.file_url)) {
		...
		if (stylo.utils.is_image_file(frm.doc.file_url)) {
			$preview = $(`<div class="img_preview">
				<img
					...
					src="${stylo.utils.escape_html(frm.doc.file_url)}"
			...
			$preview = $(`<div class="img_preview">
				<video width="480" height="320" controls>
					<source src="${stylo.utils.escape_html(frm.doc.file_url)}">
			...
			$preview = $(`<div class="img_preview">
				<object style="background:#323639;" width="100%">
					<embed
						...
						width="100%"
						height="1190"
						src="${stylo.utils.escape_html(frm.doc.file_url)}" type="application/pdf"
					>
				</object>
			</div>`);
			...
			$preview = $(`<div class="img_preview">
				<audio width="480" height="60" controls>
					<source src="${stylo.utils.escape_html(frm.doc.file_url)}" type="audio/mpeg">
