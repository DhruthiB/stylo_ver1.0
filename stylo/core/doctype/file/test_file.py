...
class TestSimpleFile(StyloTestCase):
	def setUp(self):
...
class TestBase64File(StyloTestCase):
	def setUp(self):
		self.attached_to_doctype, self.attached_to_docname = make_test_doc()
...
class TestSameFileName(StyloTestCase):
	def test_saved_content(self):
		self.attached_to_doctype, self.attached_to_docname = make_test_doc()
...
class TestSameContent(StyloTestCase):
	def setUp(self):
...
class TestAttachment(StyloTestCase):
...
class TestFileOptimization(StyloTestCase):
