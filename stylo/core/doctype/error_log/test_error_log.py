...
from stylo.utils.error import _is_ldap_exception, guess_exception_source
...
_RAW_EXC = """
   File "apps/stylo/stylo/model/document.py", line 1284, in runner
     add_to_return_value(self, fn(self, *args, **kwargs))
                               ^^^^^^^^^^^^^^^^^^^^^^^^^
   File "apps/stylo/stylo/model/document.py", line 933, in fn
...
_THROW_EXC = """
   ...
   File "apps/erpnext/erpnext/selling/doctype/sales_order/sales_order.py", line 58, in onload
     stylo.throw("what")
   File "apps/stylo/stylo/__init__.py", line 550, in throw
     msgprint(
   File "apps/stylo/stylo/__init__.py", line 518, in msgprint
     _raise_exception()
   File "apps/stylo/stylo/__init__.py", line 467, in _raise_exception
     raise raise_exception(msg)
 stylo.exceptions.ValidationError: what
"""
...
class TestExceptionSourceGuessing(IntegrationTestCase):
	@patch.object(stylo, "get_installed_apps", return_value=["stylo", "erpnext", "3pa"])
