...
stylo.ui.form.on("DocType", {
	...
	after_save: function (frm) {
		if (
			stylo.form_builder &&
			stylo.form_builder.doctype === frm.doc.name &&
			stylo.form_builder.store
		) {
...
function render_form_builder(frm) {
	if (stylo.form_builder && stylo.form_builder.doctype === frm.doc.name) {
	...
	if (stylo.form_builder) {
		...
		stylo.form_builder.doctype = frm.doc.name;
		stylo.form_builder.customize = false;
