...
class TestNamingSeries(IntegrationTestCase):
	...
	def test_get_transactions(self):
		...
		existing_naming_series = stylo.get_meta(self.ns_doctype).get_field("naming_series").options
	...
	def test_updates_naming_options(self):
		...
		self.assertIn(test_series, stylo.get_meta(self.ns_doctype).get_naming_series_options())
