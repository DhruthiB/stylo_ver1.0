...
def run_server_script_for_doc_event(doc, event):
	...
	if scripts:
		...
		for script_name in scripts:
			stylo.get_cached_doc("Server Script", script_name).execute_doc(doc)
...
def get_server_script_map():
	...
	script_map = stylo.client_cache.get_value("server_script_map")
	if script_map is None:
		...
		stylo.client_cache.set_value("server_script_map", script_map)
