...
class StyloAPITestCase(IntegrationTestCase):
...
class TestResourceAPI(StyloAPITestCase):
	DOCTYPE = "ToDo"
...
class TestMethodAPI(StyloAPITestCase):
	def test_ping(self):
...
class TestWSGIApp(StyloAPITestCase):
