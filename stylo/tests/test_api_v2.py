...
from frappe.tests.test_api import StyloAPITestCase, suppress_stdout
...
class TestResourceAPIV2(StyloAPITestCase):
	version = "v2"
	DOCTYPE = "ToDo"
...
class TestMethodAPIV2(StyloAPITestCase):
	version = "v2"
...
class TestDocTypeAPIV2(StyloAPITestCase):
	version = "v2"
...
class TestReadOnlyMode(StyloAPITestCase):
