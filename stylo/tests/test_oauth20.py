...
class StyloRequestTestCase(IntegrationTestCase):
	@property
	def sid(self) -> str:
...
class TestOAuth20(StyloRequestTestCase):
...
def check_valid_openid_response(access_token=None, client: "StyloRequestTestCase" = None):
