...
class TestSiteCache(StyloAPITestCase):
...
class TestRedisCache(StyloAPITestCase):
...
class TestDocumentCache(StyloAPITestCase):
	TEST_DOCTYPE = "User"
...
class TestRedisWrapper(StyloAPITestCase):
...
class TestHttpCache(StyloAPITestCase):
