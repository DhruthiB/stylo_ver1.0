...
from stylo.core.doctype.file.file import FILE_ENCODING_OPTIONS
...
def read_csv_content(fcontent, use_sniffer: bool = False):
	...
	content = [stylo.safe_decode(line) for line in fcontent.splitlines(True)]
	...
	if use_sniffer:
		...
		try:
			...
			dialect = sniffer.sniff(
				sample="\n".join(sample_content), delimiters=stylo.flags.delimiter_options
			)
		except csv.Error:
