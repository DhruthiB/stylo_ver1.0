...
def export_fixtures(app=None):
	...
	if app:
		...
		apps = stylo.get_installed_apps()
	for app in apps:
		fixture_auto_order = bool(next(iter(stylo.get_hooks("fixture_auto_order", app_name=app)), False))
		fixtures = stylo.get_hooks("fixtures", app_name=app)
		prefix = None
		for index, fixture in enumerate(fixtures, start=1):
			...
			export_json(
				fixture,
				stylo.get_app_path(app, "fixtures", filename + ".json"),
				filters=filters,
