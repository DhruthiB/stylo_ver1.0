...
def _(msg: str, lang: str | None = None, context: str | None = None) -> str:
	...
	if not hasattr(stylo.local, "lang"):
		stylo.local.lang = lang or "en"
	...
	msg = stylo.as_unicode(msg).strip()
...
def _lt(msg: str, lang: str | None = None, context: str | None = None):
	...
	"""
	from stylo.types.lazytranslatedstring import _LazyTranslate
...
def set_user_lang(user: str, user_language: str | None = None) -> None:
	...
	stylo.local.lang = get_user_lang(user) or user_language
