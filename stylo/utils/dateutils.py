...
from stylo.utils import add_to_date, get_datetime, getdate
...
def get_user_date_format():
	if getattr(stylo.local, "user_date_format", None) is None:
		stylo.local.user_date_format = stylo.defaults.get_global_default("date_format") or "yyyy-mm-dd"
...
def datetime_in_user_format(date_time):
	...
	from stylo.utils import formatdate
