...
// 		cy.window().its('stylo').then(stylo => {
// 			stylo.call("stylo.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/stylo.model.utils.user_settings.save')
