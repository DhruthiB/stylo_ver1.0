...
context("Sidebar", () => {
	before(() => {
		...
		return cy
			...
			.its("stylo")
			.then((stylo) => {
				return stylo.call("stylo.tests.ui_test_helpers.create_doctype_for_attachment");
			});
	});

	it("Verify attachment visibility config", () => {
		cy.call("stylo.tests.ui_test_helpers.create_todo", {
	...
	it("Verify attachment accessibility UX", () => {
		cy.call("stylo.tests.ui_test_helpers.create_todo_with_attachment_limit", {
