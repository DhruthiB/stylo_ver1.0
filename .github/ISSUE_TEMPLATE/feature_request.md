...
1. This tracker should only be used to report bugs and request features / enhancements to Stylo
    ...
    - For documentation issues, use https://frappeframework.com/docs/user/en or the developer cheetsheet https://frappeframework.com/docs/user/en/forge/resources/forge-commands-cheatsheet
